...
describe("MiniAgent", () => {
  ...
  describe("subscription timing", () => {
    it.effect("tapEventStream guarantees subscription is established before effect completes", () =>
      Effect.gen(function*() {
        const agent = yield* makeMiniAgent(testAgentName, testContextName)
    ...
    it.effect("tapEventStream receives events added immediately after subscription", () =>
      Effect.gen(function*() {
        const agent = yield* makeMiniAgent(testAgentName, testContextName)
